import { N as NoImageMetadata, Y as UnsupportedImageFormat, Z as AstroError, j as MissingSharp } from "./errors-data_B0t61Pcc.mjs";
import { y as detector } from "./path_CH3gsviT.mjs";
import { i as resolveDefaultOutputFormat, n as baseService, r as parseQuality } from "./generic_DHoFwlC3.mjs";
//#region node_modules/.pnpm/astro@7.2.10_@emnapi+core@1_57ed9b3a55d33fb72b179382db03b1c3/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_lVECwsjb.mjs")).default;
	} catch {
